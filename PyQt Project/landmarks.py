...
def getLandmarks():
    ...
    landmarks.append(Landmark("Dolmabahçe Palace", os.path.join(root, "dolmabahce.jpg")))
    ...
    landmarks.append(Landmark("Fatih Sultan Mehmet Bridge", os.path.join(root, "fsm.jpg")))
    ...
    landmarks.append(Landmark("Cappadocia", os.path.join(root, "kapadokya.jpg")))
    ...
    landmarks.append(Landmark("Machu Picchu", os.path.join(root, "machu_picchu.jpg")))
    ...
    landmarks.append(Landmark("Sydney Harbour Bridge", os.path.join(root, "sydney.jpg")))
    landmarks.append(Landmark("Taj Mahal", os.path.join(root, "taj_mahal.jpg")))
    landmarks.append(Landmark("Topkapı Palace", os.path.join(root, "topkapi.jpg")))
    ...
    landmarks.append(Landmark("Grand Mosque of Bursa", os.path.join(root, "ulu_cami.jpg")))
