...
# 'cdb6c3ae1a19c63f', 'https://upload.wikimedia.org/wikipedia/commons/f/f5/Olympic_Rings_at_Tower_Bridge_-_panoramio.jpg', '23777']
def download_image(key_url):
    (key, url, idx) = key_url
    out_dir = os.path.join("../Data/train", idx)
    ...
    try:
        pil_image_rgb = pil_image_rgb.resize((96, 96))
